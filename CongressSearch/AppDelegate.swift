...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func createMenuView() {
        ...
        leftViewController.mainViewController = legislatorViewController
        
        let slideMenuController = SlideMenuController(mainViewController:legislatorViewController, leftMenuViewController: leftViewController, rightMenuViewController: rightViewController)
